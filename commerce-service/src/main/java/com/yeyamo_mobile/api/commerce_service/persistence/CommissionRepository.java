...
public interface CommissionRepository extends JpaRepository<CommissionRule,UUID>,JpaSpecificationExecutor<CommissionRule>{
 Optional<CommissionRule>findByIdempotencyKey(String key);
