...
public interface SpringCommentRepository extends JpaRepository<CommentEntity,UUID>{List<CommentEntity>findByPostIdAndStatusOrderByCreatedAtAsc(UUID id,CommentStatus s,Pageable p);long countByPostIdAndStatus(UUID id,CommentStatus s);}
