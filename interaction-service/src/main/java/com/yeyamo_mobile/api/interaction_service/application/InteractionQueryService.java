...
public class InteractionQueryService{
 private final RelationRepository relations;private final CommentRepository comments;private final ShareRepository shares;private final CheckInRepository checks;private final InteractionCachePort cache;
 public InteractionQueryService(RelationRepository r,CommentRepository c,ShareRepository s,CheckInRepository i,InteractionCachePort cache){relations=r;comments=c;shares=s;checks=i;this.cache=cache;}
