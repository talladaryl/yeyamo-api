    ...
    @Bean SecurityFilterChain security(HttpSecurity http,JwtRolesConverter converter)throws Exception{
        return http.csrf(csrf->csrf.disable())
                ...
                .authorizeHttpRequests(auth->auth
                    ...
                    .requestMatchers(HttpMethod.POST,"/api/v1/events/*/invitations").authenticated()
                    .requestMatchers(HttpMethod.GET,"/api/v1/events/*/invitations").authenticated()
                    .requestMatchers(HttpMethod.DELETE,"/api/v1/events/*/invitations/*").authenticated()
