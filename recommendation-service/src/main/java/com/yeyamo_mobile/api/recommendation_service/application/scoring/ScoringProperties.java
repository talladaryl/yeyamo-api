...
public class ScoringProperties {
    ...
    private double cultureWeight = 1;
    ...
    public double getCultureWeight()     { return cultureWeight; }
    public void setCultureWeight(double value)     { cultureWeight     = nonNegative(value); }
