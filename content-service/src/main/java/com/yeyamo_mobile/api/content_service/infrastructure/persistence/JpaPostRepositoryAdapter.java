...
public class JpaPostRepositoryAdapter implements PostRepository{
 ...
 private PostEntity entity(Post p){PostEntity e=new PostEntity();e.setId(p.getId());e.setAuthorId(p.getAuthorId());e.setCaption(p.getCaption());e.setStatus(p.getStatus());e.setVisibility(p.getVisibility());e.setCatalogAssetId(p.getCatalogAssetId());
 ...
 private Post domain(PostEntity e){Post p=new Post();p.setId(e.getId());p.setAuthorId(e.getAuthorId());p.setCaption(e.getCaption());p.setStatus(e.getStatus());p.setVisibility(e.getVisibility());p.setCatalogAssetId(e.getCatalogAssetId());
