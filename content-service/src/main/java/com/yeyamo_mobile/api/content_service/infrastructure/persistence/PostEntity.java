...
public class PostEntity{
 ...
 @Column(name="catalog_asset_id")private UUID catalogAssetId;@Enumerated(EnumType.STRING)@Column(name="reference_type",nullable=false,length=32)private PostReferenceType referenceType=PostReferenceType.NONE;@Column(name="reference_id",length=100)private String referenceId;@Enumerated(EnumType.STRING)@Column(name="target_type",length=20)private CulturalTargetType targetType;@Column(name="target_id")private UUID targetId;
