...
public class Post{
 ...
 private UUID catalogAssetId;private List<UUID> mediaIds=new ArrayList<>();private Set<String> hashtags=new LinkedHashSet<>();
 ...
 public UUID getCatalogAssetId(){return catalogAssetId;}public void setCatalogAssetId(UUID v){catalogAssetId=v;}public List<UUID> getMediaIds(){return List.copyOf(mediaIds);}public void setMediaIds(Collection<UUID> v){mediaIds=v==null?new ArrayList<>():new ArrayList<>(v);}
