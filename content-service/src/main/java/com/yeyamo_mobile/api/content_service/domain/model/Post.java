...
public class Post{
 ...
 private UUID catalogAssetId;private PostReferenceType referenceType=PostReferenceType.NONE;private String referenceId;private CulturalTargetType targetType;private UUID targetId;private List<UUID> mediaIds=new ArrayList<>();private Set<String> hashtags=new LinkedHashSet<>();
 ...
 public void culturalTarget(CulturalTargetType type,UUID id){if(type==null&&id==null){targetType=null;targetId=null;return;}if(type==null||id==null)throw new IllegalArgumentException("Cultural target type and id must be supplied together");targetType=type;targetId=id;reference(PostReferenceType.CULTURE_CONTENT,id.toString());}
