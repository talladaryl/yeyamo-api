...
public class GlobalExceptionHandler{
 @ExceptionHandler(ContentException.class)ResponseEntity<Map<String,Object>> content(ContentException e){HttpStatus s=e.getCode().endsWith("NOT_FOUND")?HttpStatus.NOT_FOUND:e.getCode().endsWith("FORBIDDEN")?HttpStatus.FORBIDDEN:e.getCode().endsWith("TARGET_INVALID")?HttpStatus.UNPROCESSABLE_ENTITY:HttpStatus.BAD_REQUEST;return body(s,e.getCode(),e.getMessage());}
