...
public final class MissionDtos {
 ...
 public record UpdateMission(@NotBlank String title,@NotBlank String description,Instant startsAt,Instant endsAt,
   @NotBlank String rewardCode,@NotBlank String rewardTitle,@Positive int rewardAmount){}
