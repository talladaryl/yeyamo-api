...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<Map<String,Object>> constraint(ConstraintViolationException ex){return body(HttpStatus.BAD_REQUEST,"VALIDATION_ERROR","Request validation failed");}
